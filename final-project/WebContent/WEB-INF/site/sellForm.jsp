        ...
        <div id="sellformbox">
            ...
            <table id="usertable">
                <tbody>
                    ...
                    <tr>
                        <td class="col">제목</td>
                        <td><input type="text" name="title" id="svinput"></td>
                    </tr>
                    <tr>
                        <td class="col">카테고리</td>
                        <td>
                            <div id="categorybox">
                                <select id="choosecg" name="category" size="5">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="loc" id="svinput"></td>
                    </tr>
                    <tr>
                        <td class="col">상태</td>
                        <td><input type="text" name="state" id="svinput"></td>
                    </tr>
                    <tr>
                        <td class="col">가격</td>
                        <td><input type="text" name="prise" id="svinput"></td>
                    </tr>
                    <tr>
                        <td class="col">설명</td>
