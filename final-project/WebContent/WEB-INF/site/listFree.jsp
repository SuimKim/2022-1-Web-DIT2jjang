...
<body>
    ...
    <main id="listmain">
        <div id="listbox">
            <h2 id="lh">중고장터 나눔게시판</h2>
            <a href="freeform.html"><p id="lp">나눔글 작성하기 &rang;</p></a>
            <hr>
                <div class="prl">
                    <img src="pic/IMG_0176.jpg" alt="">
                    <p>고양이 구경권<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_0225.jpg" alt="">
                    <p>다이소 수세미<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_2152.jpg" alt="">
                    <p>써브웨이 기프티콘 팔아요<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_2819.jpg" alt="">
                    <p>아이패드 프로11 양도<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_3047.jpg" alt="">
                    <p>해운대 블루라인파크 이용권 4인<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_3360.jpg" alt="">
                    <p>2등일 수도 있는 로또<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_7817.jpg" alt="">
                    <p>애플워치se 스그팝니다<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_9600.jpg" alt="">
                    <p>에어서큘레이터<br><br><span>0원</span></p>
                </div>
                <div class="prl">
                    <img src="pic/IMG_9941.jpg" alt="">
                    <p>맥날 방탄세트 포장봉투...<br><br><span>0원</span></p>
                </div>
                <a href="(미완)sellview.html"><div class="prl">
                    <img src="pic/IMG_2986.jpg" alt="">
                    <p>추억의 다마고치입니다<br><br><span>0원</span></p>
                </div></a>
                <div class="prl">
                    <img src="pic/IMG_0176.jpg" alt="">
                    <p>고양이 구경권<br><br><span>0원</span></p>
